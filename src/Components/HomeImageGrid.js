...
function HomeImageGrid() {
  ...
  return (
    <section className="max-w-[80rem] m-auto pt-4 px-8">
      <div className="grid grid-cols-3 place-content-center place-items-center my-[1rem] mt-[1rem] sm:mt-0">
        <div>
          <img
            src={mensfashion}
            alt="mensfashion"
            className="xl:h-[48rem] xl:w-[24rem] lg:h-[44rem] lg:w-[18rem] md:h-[28rem] md:w-[16rem] sm:h-[20rem] sm:w-[12rem] w-[6.8rem] h-[16rem]"
          />
        </div>
        <div className="flex flex-col items-center justify-center">
          ...
          />
          <h2 className="text-[#484848] text-center lg:text-[5rem] md:text-[2.8875rem] text-[1.35rem] tracking-tight font-medium">
            ULTIMATE
          </h2>
          <h2 className="text-center text-[#484848] lg:text-[10rem] md:text-[5.6875rem] text-[2.8rem] -m-[0.55rem] sm:m-[-0.8rem] md:m-[-2.2rem] lg:m-[-2rem] xl:m-[-2.2rem] font-medium text-stroke">
            SALE
          </h2>
        ...
        <div>
          <img
            src={womensfashion}
            alt="womensfashion"
            className="xl:h-[48rem] xl:w-[24rem] lg:h-[44rem] lg:w-[18rem] md:h-[28rem] md:w-[16rem] sm:h-[20rem] sm:w-[12rem] w-[6.75rem] h-[16rem]"
          />
        </div>
      </div>
    </section>
